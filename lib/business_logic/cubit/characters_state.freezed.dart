...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$CharactersStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
abstract class Idle<T> implements CharactersState<T> {
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'CharactersState<$T>.error(networkExceptions: $networkExceptions)';
  }
